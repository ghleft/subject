...
const ART3 = `${process.env.PUBLIC_URL}/content/art/art-03.webp`;
...
const POSTS = [
  ...
  { id: "art-3", category: "art", title: "미제출", author: "익명D",  tag: ["계깡"], images: [ART3] },
  { id: "art-4", category: "art", title: "미제출", author: "비누",   tag: ["계묭"], images: [ART3] },
