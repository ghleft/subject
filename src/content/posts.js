const ART = (folder, count) =>
  Array.from({ length: count }, (_, i) =>
    `${process.env.PUBLIC_URL}/content/art/${folder}/${folder}_${i}.webp`
  );

const ART1 = `${process.env.PUBLIC_URL}/content/art/art-01.webp`;
...
const POSTS = [
  ...
  { id: "fic-4", category: "fiction", title: "E의 연애",                author: "익명B",  tag: ["계깡"],         tag2: ["ADULT"], bodyUrl: `${process.env.PUBLIC_URL}/content/fic/fic-4.md` },
  { id: "fic-5", category: "fiction", title: "안녕하세요",                  author: "겐",     tag: ["둥헌"],         bodyUrl: `${process.env.PUBLIC_URL}/content/fic/fic-5.md` },
  ...
  { id: "fic-8", category: "fiction", title: "(비)독과점연애",                  author: "짱",     tag: ["둥연"],         bodyUrl: `${process.env.PUBLIC_URL}/content/fic/fic-8.md` },
  { id: "fic-9", category: "fiction", title: "독약이라도 기꺼이",         author: "익명C",  tag: ["계묭"],         bodyUrl: `${process.env.PUBLIC_URL}/content/fic/fic-9.md` },

  { id: "art-1", category: "art", title: "파랑",   author: "고까냥", tag: ["계깡"], images: [ART1] },
  { id: "art-2", category: "art", title: "도착!", author: "짱페스",  tag: ["둥헌"], images: ART("art-02", 10) },
  { id: "art-3", category: "art", title: "이상 취향", author: "비누",  tag: ["계묭"], images: ART("art-03", 3) },
